          ...
          return (
            <li key={p.slug}>
              <Link
                ...
                className="motion-lift group flex items-start gap-4 rounded-2xl bg-bg-elevated p-5 ring-1 ring-border transition hover:-translate-y-0.5 hover:ring-accent/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-ink sm:gap-5 sm:p-6"
              >
                <span
                  aria-hidden="true"
                ...
                <ArrowIcon
                  className="mt-1 h-5 w-5 shrink-0 text-muted transition group-hover:translate-x-0.5 group-hover:text-accent-ink"
                />
              </Link>
            </li>
          );
